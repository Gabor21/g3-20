var UrlGetPedidos='http://34.68.196.220:90/G3.20-/Pedidos/controller/pedidos.php?op=GetPedidos';
var UrlPostPedido='http://34.68.196.220:90/G3.20-/Pedidos/controller/pedidos.php?op=InsertPedidos';
var UrlGetUno='http://34.68.196.220:90/G3.20-/Pedidos/controller/pedidos.php?op=GetUno';
var UrlPutPedido='http://34.68.196.220:90/G3.20-/Pedidos/controller/pedidos.php?op=UpdatePedidos';
var UrlDeletePedido='http://34.68.196.220:90/G3.20-/Pedidos/controller/pedidos.php?op=DeletePedidos';
...
function CargarPedido(idpedido){
    ...
    success: function(response){
        ...
        var btnactualizar = '<input type="submit" value="Actualizar Pedido" id="btn_actualizar" onclick=" ActualizarPedido('+MiItems[0].ID+') " class="btn btn-primary"></input>';
